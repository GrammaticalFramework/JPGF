...
public class LinTriple {
  ...
  public LinTriple(int _fId, CncType _cncType, Vector<Vector<BracketedTokn>> _linTable)
  ...
  public String toString() {String rez = "id : "+fId+ " cncType : ("+cncType.toString()+") bracketedToken :["+linTable.toString();
                            rez+="]";
                            return rez;
                            	}
}
