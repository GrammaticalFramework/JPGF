...
public class Generator {
	...
	{if(type.equals("Integer"))
	      return new LiteralExp(new IntLiteral(generateInt()));
	else if(type.equals("Float"))
		  return new LiteralExp(new FloatLiteral(generateFloat()));
	else if(type.equals("String"))
		  return new LiteralExp(new StringLiteral(generateString()));
