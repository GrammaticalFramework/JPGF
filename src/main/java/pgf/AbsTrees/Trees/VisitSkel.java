...
public class VisitSkel
{
  ...
  {
    public R visit(Trees.Absyn.Lambda p, A arg)
    {
    ...
    public R visit(Trees.Absyn.Variable p, A arg)
    {
    ...
    public R visit(Trees.Absyn.Application p, A arg)
    {
    ...
    public R visit(Trees.Absyn.Literal p, A arg)
    {
    ...
    public R visit(Trees.Absyn.MetaVariable p, A arg)
    {
    ...
    public R visit(Trees.Absyn.Function p, A arg)
    {
