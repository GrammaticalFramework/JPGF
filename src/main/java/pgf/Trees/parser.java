...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu May 20 15:44:27 CEST 2010
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  public pgf.Trees.Absyn.Tree pTree() throws Exception
  {
	java_cup.runtime.Symbol res = parse();
	return (pgf.Trees.Absyn.Tree) res.value;
  }
      ...
      switch (CUP$parser$act_num)
        {
          ...
          case 9: // Lit ::= _STRING_ 
            {
              pgf.Trees.Absyn.Lit RESULT =null;
		String p_1 = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new pgf.Trees.Absyn.StringLiteral(p_1); 
		...
		Double p_1 = (Double)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new pgf.Trees.Absyn.FloatLiteral(p_1); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("Lit",1, RESULT);
            }
          return CUP$parser$result;
		...
		Integer p_1 = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new pgf.Trees.Absyn.IntLiteral(p_1); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("Lit",1, RESULT);
            }
          return CUP$parser$result;
          ...
          case 6: // Tree ::= _IDENT_ 
            {
              pgf.Trees.Absyn.Tree RESULT =null;
		String p_1 = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new pgf.Trees.Absyn.Function(p_1); 
		...
		Integer p_2 = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new pgf.Trees.Absyn.MetaVariable(p_2); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("Tree",0, RESULT);
            }
          return CUP$parser$result;
          ...
          case 4: // Tree ::= Lit 
            {
              pgf.Trees.Absyn.Tree RESULT =null;
		pgf.Trees.Absyn.Lit p_1 = (pgf.Trees.Absyn.Lit)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new pgf.Trees.Absyn.Literal(p_1); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("Tree",0, RESULT);
            }
          return CUP$parser$result;
          ...
          case 3: // Tree ::= _SYMB_3 Tree Tree _SYMB_4 
            {
              pgf.Trees.Absyn.Tree RESULT =null;
		pgf.Trees.Absyn.Tree p_2 = (pgf.Trees.Absyn.Tree)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		pgf.Trees.Absyn.Tree p_3 = (pgf.Trees.Absyn.Tree)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new pgf.Trees.Absyn.Application(p_2,p_3); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("Tree",0, RESULT);
            }
          return CUP$parser$result;
          ...
          case 2: // Tree ::= _SYMB_2 _INTEGER_ 
            {
              pgf.Trees.Absyn.Tree RESULT =null;
		Integer p_2 = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new pgf.Trees.Absyn.Variable(p_2); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("Tree",0, RESULT);
            }
          return CUP$parser$result;
		...
		pgf.Trees.Absyn.Tree p_4 = (pgf.Trees.Absyn.Tree)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new pgf.Trees.Absyn.Lambda(p_2,p_4); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("Tree",0, RESULT);
            }
          return CUP$parser$result;
          ...
          case 0: // $START ::= Tree EOF 
            {
              Object RESULT =null;
		pgf.Trees.Absyn.Tree start_val = (pgf.Trees.Absyn.Tree)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		RESULT = start_val;
