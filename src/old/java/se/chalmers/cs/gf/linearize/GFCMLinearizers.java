 ...
 */
public class GFCMLinearizers extends Linearizers {
        
	public GFCMLinearizers(GFCMModules modules) {
                for (GFCModule m : modules.getMainConcreteModules()) {
			addLinearizer(new GFCLinearizer(m));
                }
        }
