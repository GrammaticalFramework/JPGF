 ...
 */
public class IntLiteralRule extends TerminalRule {

        public IntLiteralRule() {
                super(new Category("Int{}.s"), new Terminal("<integer literal>"));
        }

        public Tree makeTree(Token t, int startIndex, int endIndex) {
                return new IntLiteral(t.intValue(), startIndex, endIndex);
        }
