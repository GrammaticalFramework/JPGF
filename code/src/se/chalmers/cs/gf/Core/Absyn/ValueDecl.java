...
public class ValueDecl extends Decl {
  ...
  public ValueDecl(String p1, Exp p2) { cident_ = p1; exp_ = p2; }

  public <R,A> R accept(se.chalmers.cs.gf.Core.Absyn.Decl.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof se.chalmers.cs.gf.Core.Absyn.ValueDecl) {
      se.chalmers.cs.gf.Core.Absyn.ValueDecl x = (se.chalmers.cs.gf.Core.Absyn.ValueDecl)o;
